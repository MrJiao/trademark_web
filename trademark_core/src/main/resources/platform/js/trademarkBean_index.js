    ...
    return{
        init: function (){
            trademarkBeanList = $("#commonList").jqGrid({
                ...
                mtype: "GET",
                multiselect: true,
                colNames: ["id","页码","商标号","期号","类别","排序","申请日期","商标名","解析名称","个数","国外","申请人","地址","代理机构","异议开始","异议截止","公告日期","类型","被选择的类型","备注1","备注2","备注3","创建时间"],
                colModel: [
                    ...
                    { name: "leibie", index:"leibie",align:"center",hidden: false, sortable: true},
                    { name: "mOrder", index:"mOrder",align:"center",hidden: false, sortable: true},
                ...
                rowNum: 10,
                rowList: [10, 20,40,80],
                sortname:"analysisCount desc,analysisName asc,name asc",
                sortorder:"desc",
                viewrecords: true,
                multiSort: true,
                gridview: true,
